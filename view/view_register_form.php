    ...
    <form method="post" action="controller/userRegistration.php">
        <div class="form-group">
            ...
            <input name="email" type="email" class="form-control" id="email" aria-describedby="emailHelp"
                   placeholder="Enter email" autocomplete="off" autofocus required>
        ...
        <div class="form-group">
            ...
            <input name="nickname" type="text" class="form-control" id="nickname" aria-describedby="nicknameHelp"
                   placeholder="Enter a nickname" autocomplete="off" required pattern="(.{3,})"
